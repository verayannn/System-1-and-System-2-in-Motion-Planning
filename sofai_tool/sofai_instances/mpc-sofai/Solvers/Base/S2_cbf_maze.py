...
def simulate_sfcbf(
    ...
    *,
    ...
    '''Returns a dict with keys:
        - states: list of [x,y] states at each step (including initial state) -- This is the solution to train S1
        - inputs: list of [u1,u2] control inputs at each step (length one less than states)
        - runtime_sec: total wall time of the simulation in seconds
        - success: boolean flag indicating if the scenario was successfully solved (collision-free and goal reached)
        - collision_free: boolean flag indicating if the trajectory was collision-free
        - goal_reached: boolean flag indicating if the goal was reached within tolerance
        - ok_qp_all_steps: boolean flag indicating if the QP was feasible at all
        - T_steps_executed: total number of steps executed (until goal reached or max steps)'''
