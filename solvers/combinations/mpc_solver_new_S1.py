...
MPLCONFIGDIR=/private/tmp/mpl /Users/apple/miniconda3/envs/s12_env/bin/python3.10 mpc_solver_new_S1.py --problem_dictionary benchmark_scenarios_maze_1199_block200.json --scenario_id 1
...
from ..S2_mpc import solve_MPC
from ..S1_memory_neural import solveMemoryNeural
from ..base.S2_mpc_maze import collision_free_rectangles, goal_reached
...
# ============================================================
# SYSTEM 1 (memory + neural S1, no System-2 dependency)
# ============================================================
...
class CustomSystem1Solver(sofai1.System1Solver):
    ...
    def solve(self, problem_id):
        ...
        try:
            ...
            self.s1_source = info.get("source", "none")
            self.s1_details = info
